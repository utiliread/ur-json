...
describe('modelBind', function () {
    ...
    it("should support polymorphic models", function () {
        var result = modelBind(PolySub, JSON.parse('{"id":1,"sub":"hello"}'));
        expect(result === null || result === void 0 ? void 0 : result.id).equals(2);
        expect(result === null || result === void 0 ? void 0 : result.sub).equals("hellotest");
    });
});
